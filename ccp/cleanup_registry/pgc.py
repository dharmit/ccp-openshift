...
from ccp.cleanup_registry import config
from ccp.cleanup_registry.garbagecollector import \
    RegistryGarbageCollector
from ccp.cleanup_registry.index_registry_diff import diff
import ccp.lib.core
import os
...
class PipelineRegistryGarbageCollector(RegistryGarbageCollector):
    ...
    def prep_index(self):
        ...
        if self.local_index:
            ...
            ccp.lib.core.print_msg("Cloning container index...", self.verbose)
            ccp.lib.core.clone_repo(self.index_git, self.index_location)
            index_preped = True
    ...
    def post_removal(self):
        ccp.lib.core.print_msg("No post removal tasks", self.verbose)
