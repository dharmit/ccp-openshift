from ccp.cleanup_registry.registry import \
...
class RegistryGarbageCollector(object):
    ...
    def mark_for_removal(self):
        ccp.lib.core.print_msg("Marking mismatched containers for removal...",
                      self.verbose)
    ...
    def collect(self):
        ccp.lib.core.print_msg("Performing pre-garbage collection ops", self.verbose)
        self.pre_removal()
        ccp.lib.core.print_msg(
            str.format(
        ...
        if self.g_collect:
            cccp.lib.core.print_msg("Cleaning up images...", self.verbose)
